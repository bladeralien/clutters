...
# $HBASE_PREFIX/bin/hbase-daemon.sh --config "${HBASE_CONF_DIR}" start master | tee $HBASE_PREFIX/logs/hbase-master.log
# # TODO foreground
# $HADOOP_PREFIX/bin/hdfs --config $HADOOP_CONF_DIR datanode
...
$HBASE_PREFIX/bin/hbase-daemon.sh --config "${HBASE_CONF_DIR}" foreground_start regionserver
